...
FCKConfig.ToolbarSets["Default"] = [
	...
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Link','Unlink'],
	['Image','Table','Rule','Smiley','TextColor','BGColor','PasteText','PasteWord','FitWindow','Preview'],
	'/',
	['Style','FontFormat','FontName','FontSize']
] ;
...
// FCKConfig.ContextMenu = ['Generic'] ; /* 右键菜单 */
